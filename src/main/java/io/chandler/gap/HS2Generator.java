...
public class HS2Generator {
	static final File hs2States = new File("hs2.gap.lz4");
	static final File outDir = new File("hs2.gap.states");
	...
	public static void main(String[] args) throws Exception {
        ...
        for (String type : types) {
            ...
            File cyclesFile = new File("PlanarStudyMulti/hs_2/"+type+".txt");
    ...
    public static List<int[][]> loadHS2CategoryStates(String category) throws Exception {
        ...
        File src = new File(outDir, category + ".hs2.bytes.lz4");
    ...
    public static void categorizeHS2States(File in, File outDir) throws Exception {
        ...
        exploreHS2(in, (state, desc) -> {
            if (!cycleDescriptionToFile.containsKey(desc)) {
                File file = new File(outDir, desc + ".hs2.bytes.lz4");
                try {
    ...
    public static void GenerateHS2(File file) throws Exception {
        Set<State> set = new LongStateCache(18, 100);
        int elements = 100;
        int order = 88704000;
        GroupExplorer group = new GroupExplorer(
            Generators.hs_2, MemorySettings.DEFAULT, set);
